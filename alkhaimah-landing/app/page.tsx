...
import { ChevronLeft, Headphones, ImageIcon, Newspaper, Play, Volume2, Phone } from "lucide-react"
...
import { AppMockupShowcase } from "@/components/app-mockup-showcase"
import { AppMockupSingle } from "@/components/app-mockup-single"
    ...
    <div className="min-h-screen bg-[#DAD5D2]">
      ...
      <header className="fixed top-0 left-0 right-0 bg-white z-50 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-2">
            <DownloadButton className="bg-[#C13144] hover:bg-[#a52a3a] text-white hidden md:flex">
              جربه الآن
            </DownloadButton>
      ...
      <div className="pt-[72px]">
        <main>
                ...
                <div className="md:w-1/2 space-y-6 text-right">
                  ...
                  <ScrollReveal delay={600}>
                    <div className="flex gap-4">
                      <DownloadButton className="bg-[#C13144] hover:bg-[#a52a3a] text-white text-lg px-8 py-6 group">
                ...
                <div className="md:w-1/2 relative">
                  <ScrollReveal direction="left">
                    <div className="relative h-[500px] w-full flex items-center justify-center">
                      ...
                      <AppMockupSingle
                        imageUrl="/images/alkhaimah-mockup-1.png"
                        alt="تطبيق الخيمة"
          ...
          {/* About Section - Removed Sadu pattern from sides */}
          <SectionPattern variant="primary" id="about" showPattern={false}>
                ...
                <ScrollReveal className="md:w-1/2" direction="right">
                  <div className="relative">
                    ...
                    <div className="relative bg-white p-6 rounded-lg shadow-lg">
                      <AppMockupSingle
                        imageUrl="/images/alkhaimah-mockup-2.png"
                        alt="تطبيق الخيمة - شاشة الاستماع"
                        className="w-full"
                      />
                    </div>
                  </div>
          ...
          {/* Features Section - Removed Sadu pattern from sides */}
          <SectionPattern variant="dark" id="features" showPattern={false}>
            <div className="container mx-auto px-4 relative z-10">
              <ScrollReveal>
                <div className="text-center mb-16">
                  <h2 className="text-3xl md:text-4xl font-bold font-ibm-plex mb-4 text-white">الميزات</h2>
                  <div className="relative">
                    <Separator className="w-24 h-1 bg-[#C13144] mx-auto" />
                  </div>
                </div>
              ...
              <ScrollReveal delay={700}>
                <div className="mt-16 text-center">
                  <h3 className="text-2xl font-bold font-ibm-plex mb-6 text-white">كيف يعمل؟</h3>
                  <div className="relative">
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                      <div className="bg-[#3a3b3c] p-6 rounded-lg relative">
                        ...
                        <h4 className="text-xl font-bold mb-4 mt-6 font-ibm-plex text-white">جمع الأخبار</h4>
                        <p className="text-white">يبدأ بجمع الأخبار من مصادر موثوقة باستخدام تقنية LangChain</p>
                      </div>
                      ...
                      <div className="bg-[#3a3b3c] p-6 rounded-lg relative">
                        ...
                        <h4 className="text-xl font-bold mb-4 mt-6 font-ibm-plex text-white">تلخيص وصياغة</h4>
                        <p className="text-white">نلخص المحتوى ونستخرج أهم النقاط ثم نعيد صياغته باللهجة المحببة</p>
                      </div>
                      ...
                      <div className="bg-[#3a3b3c] p-6 rounded-lg relative">
                        ...
                        <h4 className="text-xl font-bold mb-4 mt-6 font-ibm-plex text-white">تحويل إلى صوت وصورة</h4>
                        <p className="text-white">تتحول الأخبار إلى صوت وتُولد صورة فريدة لكل حلقة تعكس موضوعها</p>
                      </div>
                    </div>
                  </div>
          ...
          {/* App Preview Section - Updated with new mockups */}
          <SectionPattern variant="secondary" showPattern={false}>
            <div className="container mx-auto px-4 relative z-10">
              <ScrollReveal>
                <div className="text-center mb-16">
              ...
              <ScrollReveal delay={800}>
                <div className="mt-16 text-center">
                  ...
                  <DownloadButton className="bg-[#C13144] hover:bg-[#a52a3a] text-white text-lg px-8 py-6">
                    حمل التطبيق وجرب
                  </DownloadButton>
                </div>
              </ScrollReveal>
          ...
          {/* Team Section */}
          <SectionPattern variant="primary" id="team" showPattern={false}>
            <div className="container mx-auto px-4 relative z-10">
              <ScrollReveal>
                <div className="text-center mb-16">
          ...
          <section id="contact" className="py-20 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
              ...
              <ScrollReveal delay={400}>
                <DownloadButton className="bg-white text-[#C13144] hover:bg-gray-100 text-lg px-8 py-6 font-bold group">
                  حمل التطبيق وجرب
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-center md:text-right">
                ...
                <p>AlKhimaPlatform@outlook.com</p>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-400">
                    <p className="flex items-center gap-2">
                      ...
                      <a href="mailto:AlKhimaPlatform@outlook.com" className="hover:text-white transition-colors">
                        AlKhimaPlatform@outlook.com
                      </a>
                    </p>
                    <p className="flex items-center gap-2">
                      <Phone className="h-4 w-4" />
                      <a href="tel:0506054839" className="hover:text-white transition-colors">
                        0506054839
                      </a>
                    </p>
                  </div>
